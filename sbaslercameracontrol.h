...
public:
    ...
    enum SBaslerCameraControl_Type{
        ...
        Type_Basler_PixelFormat, //灯的触发信号
    };
    void initSome();
    void deleteAll();
    QStringList cameras();
    ...
    void autoImageAdjust(int timeout);

    void setPixelFormat(QString type);
    ...
    long GrabImage(Mat &image, int timeout = 2000);
